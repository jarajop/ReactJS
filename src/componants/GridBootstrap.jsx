    ...
    <div className="container">
      <div className="row">
        <div className="col bg-success text-light">
          ...
          {/* ou bien a la place on peut definit nos propres classes et on y applique notre propre style css N'oublie jamias d'importer le css ds le composant ou
 tu vas l'utiliser et aussi pt l'importation on ne met pas de ceci from non just le chemin du  fichier .ET Aussi pr l'image on a fait ceci : src={Img1} car considerant Img1 com 1 variable
...
// Et aussi pr les chemins ./  permet de remonter au repertoire qui contient ce fichiers alors que  ../  permet de remonter au repertoire qui contient 
